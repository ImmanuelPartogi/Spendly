...
final profileProvider = StateNotifierProvider<_ProfileNotifier, _ProfileState>(
  (_) => _ProfileNotifier(),
);
...
class _ProfileNotifier extends StateNotifier<_ProfileState> {
  _ProfileNotifier() : super(const _ProfileState()) {
    _load();
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (themeMode) {
      case ThemeMode.dark:
        ...
        themeIconColor = AppColors.accentPurple;
      case ThemeMode.light:
        themeLabel = 'light'.tr();
        themeIcon = Icons.light_mode_rounded;
        themeIconColor = AppColors.warning;
      default:
        themeLabel = 'auto'.tr();
                ...
                _SettingsGroup(
                  ...
                  items: [
                    ...
                    _GroupItem(
                      ...
                      onTap: () =>
                          _showLanguageSheet(context, ref, context.locale, isDark),
                    ),
                    _GroupItem(
                      icon: themeIcon,
              ...
              Flexible(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final (code, label, flag) = options[index];
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 14.5,
                                fontWeight: FontWeight.w600,
                                color: isSelected ? AppColors.primary : txtPrim,
                              ),
                            ),
                            const Spacer(),
                            if (isSelected)
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: FontWeight.w700,
                        color:
                            _pinEnabled ? AppColors.expense : AppColors.income,
                      ),
                    ),
                  ),
                ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child:
                Center(child: Icon(item.icon, size: 15, color: item.iconColor)),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(16),
            border:
                Border.all(color: AppColors.expense.withValues(alpha: 0.30)),
          ),
          child: Row(
